...
def main(t: int = 64, nb_iter: int = 10, model_type: str = 'fnn', block_size: int = 128, batch_size: int = 16, dataset_name: str = 'cifar10', save_path: str ='/share/lucuslu/ntga/chlu/datasets'):
    """
